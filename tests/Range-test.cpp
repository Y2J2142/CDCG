...
// Testing for equality with floating point aint the best idea but its honest
// work
TEST_CASE("Iteration over floating point range")
{
	...
	SECTION("Only end of range specified")
	{
		...
		REQUIRE(std::vector{
					0.f, 1.f, 2.f, 3.f, 4.f, 5.f, 6.f, 7.f, 8.f, 9.f } == vec);
	}
	...
	SECTION("End and begin of range specified")
	{
		...
		REQUIRE(std::vector{ 1.f, 2.f, 3.f, 4.f, 5.f, 6.f, 7.f, 8.f, 9.f } ==
				vec);
	}
