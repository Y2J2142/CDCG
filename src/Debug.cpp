...
namespace CDCG {
	...
	Debug::Debug() : file{ stdout } {}

    Debug& Debug::operator<<(Debug::Color c) {
        switch(c) {
			case Debug::Color::BLACK:		fprintf(file, "\u001b[30m"); break;
			case Debug::Color::RED:			fprintf(file, "\u001b[31m"); break;
			case Debug::Color::GREEN:		fprintf(file, "\u001b[32m"); break;
			case Debug::Color::YELLOW:		fprintf(file, "\u001b[33m"); break;
			case Debug::Color::BLUE:		fprintf(file, "\u001b[34m"); break;
			case Debug::Color::MAGENTA:		fprintf(file, "\u001b[35m"); break;
			case Debug::Color::CYAN:		fprintf(file, "\u001b[36m"); break;
			case Debug::Color::WHITE:		fprintf(file, "\u001b[37m"); break;
			case Debug::Color::RESET:		fprintf(file, "\u001b[0m"); break;
    ...
    Debug& Debug::operator<<(Debug::BackgroundColor c) {
        switch(c) {
		case Debug::BackgroundColor::BLACK:		fprintf(file, "\u001b[40m"); break;
		case Debug::BackgroundColor::RED:		fprintf(file, "\u001b[41m"); break;
		case Debug::BackgroundColor::GREEN:		fprintf(file, "\u001b[42m"); break;
		case Debug::BackgroundColor::YELLOW:	fprintf(file, "\u001b[43m"); break;
		case Debug::BackgroundColor::BLUE:		fprintf(file, "\u001b[44m"); break;
		case Debug::BackgroundColor::MAGENTA:	fprintf(file, "\u001b[45m"); break;
		case Debug::BackgroundColor::CYAN:		fprintf(file, "\u001b[46m"); break;
		case Debug::BackgroundColor::WHITE:		fprintf(file, "\u001b[47m"); break;
		case Debug::BackgroundColor::RESET:		fprintf(file, "\u001b[0m"); break;
